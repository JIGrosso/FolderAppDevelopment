...
namespace BuddyPress.Utility
{
    ...
    public class HttpHelper
    {
        ...
        private static Exception CreateUnexpectedResponseException(HttpResponseMessage response, string responseString)
        {
            ...
            WordPressPCL.Models.BadRequest badrequest;
            try
            {
                badrequest = JsonConvert.DeserializeObject<WordPressPCL.Models.BadRequest>(responseString);
            }
